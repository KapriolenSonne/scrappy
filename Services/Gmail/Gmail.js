...
module.exports = {
  ...
  */
   ...
   */
  listLabels: async function listLabels(auth) {
  ...
  getLastMessageByPattern: async function getLastMessageByPattern(auth, { from, subject }) {
    const gmail = google.gmail({version: 'v1', auth});
    ...
    const targetedMessage = resMessage.data;
